...
-- Removendo tabelas existentes para evitar erros de duplicação
...
CREATE TABLE `disciplina` (
    ...
    `siape_prof` VARCHAR(20) DEFAULT NULL,
...
CREATE TABLE `turma` (
    ...
    PRIMARY KEY (`id_turma`, `id_disciplina`), -- Chave primária composta para permitir várias disciplinas por turma
