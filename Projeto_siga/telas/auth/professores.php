...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['acao']) && $_POST['acao'] === 'excluir' && isset($_POST['siape_excluir'])) {
        ...
        if ($professorServico->excluirProfessor($siape_excluir)) {
            $_SESSION['op_success'] = "Professor excluído com sucesso!";
        } else {
            $_SESSION['op_error'] = "Erro ao excluir o professor.";
        }
...
try {
    ...
    $_SESSION['op_error'] = "Erro ao carregar a lista de professores.";
...
<head>
    ...
    <title>Gerenciar Professores - SIGA</title>
...
<div class="sidebar">
    ...
    <ul>
        ...
        <li><a href="professores.php" class="active"><i class="fas fa-chalkboard-teacher"></i> <span>Professores</span></a></li>
...
<div class="main-content">
    <div class="header">
        ...
        <a href="cadastro.php" class="btn-add"><i class="fas fa-plus"></i> Novo Professor</a>
    </div>
                    ...
                    <?php foreach ($professores as $professor): ?>
                        <tr>
                            ...
                            <td class="actions-cell">
                                <a href="editar_professor.php?siape=<?php echo htmlspecialchars($professor['siape_prof']); ?>" class="btn-action btn-edit">Editar</a>
                                <form action="professores.php" method="POST" style="display:inline;" onsubmit="return confirm('Tem certeza que deseja excluir o professor <?php echo htmlspecialchars(addslashes($professor['nome'])); ?>? Esta ação não pode ser desfeita.');">
